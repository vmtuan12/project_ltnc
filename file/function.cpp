...
void imageFunc::load_bgr(SDL_Renderer *ren, int y)
{
    imageFunc::renderTexture(background, ren, 0, y, 720, SCREEN_HEIGHT);
    imageFunc::renderTexture(background, ren, 0, y-SCREEN_HEIGHT, 720, SCREEN_HEIGHT);
