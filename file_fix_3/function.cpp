...
bool imageFunc::load_img_bgr(SDL_Renderer *ren)
{
    ...
    menu = imageFunc::loadTexture("bgr/menu.bmp",ren);
    ...
    if (background == nullptr || control == nullptr || menu == nullptr || naming == nullptr || upgraded == nullptr ||
        basicCar == nullptr || iLock == nullptr || iEv == nullptr || iBm == nullptr)
            return false;
